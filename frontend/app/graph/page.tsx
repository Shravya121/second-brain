...
export default function Graph() {
  ...
  useEffect(() => {
    async function loadGraph() {
      try {
        ...
        if (nodes.length === 0) {
          setStatus("No items saved yet. Add some notes in Dashboard first!");
          return;
        }
  ...
  function drawGraph(nodes: any[], edges: any[]) {
    ...
    import("d3").then((d3) => {
      ...
      const node = svg.append("g")
        ...
        .attr("fill", (d: any) => d.type === "tag" ? "#7c6af7" : "#1a1a24")
        .attr("stroke", (d: any) => d.type === "tag" ? "#7c6af780" : "#33334a")
        .attr("stroke-width", 2)
        .call(
  d3.drag<SVGCircleElement, any>()
    ...
    .on("end", (event: any, d: any) => {
      ...
      const label = svg.append("g")
        ...
        .attr("dy", (d: any) => d.type === "tag" ? -14 : 24)
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "calc(100vh - 4rem)" }}>
      ...
      <p className="page-subtitle">See how your notes connect through shared tags.</p>
      ...
      <div style={{ display: "flex", gap: "1rem", marginTop: "1rem", fontSize: "0.8rem", color: "var(--text-dim)" }}>
